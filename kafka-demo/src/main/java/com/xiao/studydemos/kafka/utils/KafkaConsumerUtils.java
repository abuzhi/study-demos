...
public class KafkaConsumerUtils {
    ...
    private static Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, properties.getProperty("consumer.enable.auto.commit","true"));
        props.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, properties.getProperty("consumer.auto.commit.interval.ms","100"));
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, properties.getProperty("consumer.auto.offset.reset","latest"));
        props.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, properties.getProperty("consumer.session.timeout.ms","10000"));
